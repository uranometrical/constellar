...
public class ResourcePackEntryDefault extends ResourcePackEntry {
    ...
    public ResourcePackEntryDefault(ResourcePackScreen resourcePackScreenIn)
    {
        super(resourcePackScreenIn);
        packInstance = mc.getResourcePackRepository().rprDefaultResourcePack;
